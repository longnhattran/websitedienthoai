			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<div class="order-box">
						...
						<div class="d-flex">
							<h4>Total</h4>
							<div class="ml-auto font-weight-bold">${currency}${total}</div>
						</div>
						<hr class="my-1">
						<div class="d-flex">
							<h4>Coupon Discount</h4>
							<div class="ml-auto font-weight-bold">${currency}${amountDiscount}</div>
						</div>
						<hr class="my-1">
						<div class="d-flex gr-total">
							<h5>Grand Total</h5>
							<div class="ml-auto h5">${currency}${grandTotal}</div>
						</div>
					</div>
				</div>
			</div>
